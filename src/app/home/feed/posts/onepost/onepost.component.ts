...
export class OnepostComponent implements OnInit {
  ...
  onEdit(postId: string) {
    ...
    this.editPost = this.postService.getPost(postId);
    console.log(this.editPost.postContent);
    // console.log(this.editPost.designation);
    console.log(this.editPost.time);
  ...
  setUser() {
    this.authService.distributeCurUserInfo().subscribe(user => {
      this.curUser = user;
    });
  }
