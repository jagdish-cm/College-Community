...
export class PostsComponent implements OnInit {
  ...
  // postdata: string =
  //   'Vestibulum in ultrices turpis. Curabitur at metus sodales, feugiat urna quis, euismod metus. Cras convallis iaculis tortor, eu accumsan magna consectetur in. Sed pharetra sapien quis augue venenatis, sit amet volutpat ligula consectetur. Aliquam mollis justo id sollicitudin volutpat. Integer facilisis, nunc ut luctus facilisis, ipsum elit auctor ipsum, vehicula suscipit leo velit sit amet nisl. Nunc quis pharetra nulla. Curabitur aliquet risus lectus, eu mattis enim tempor id. Phasellus dignissim rutrum facilisis. Nullam ullamcorper finibus velit quis congue.';
  // profileImg: string =
